...
const config = {
  ...
  maxRedditResults: parseInt(process.env.MAX_REDDIT_RESULTS || "5", 10), // Reduced to 5 posts only (no comments)
  sourceContentMaxLength: parseInt(
    process.env.SOURCE_CONTENT_MAX_LENGTH || "800",
    10,
  ), // Reduced from 1000
